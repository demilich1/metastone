...
import net.pferdimanzug.hearthstone.analyzer.game.spells.custom.FacelessSpell;
...
public class FacelessManipulator extends MinionCard {
	...
	public Minion summon() {
		...
		Battlecry battlecry = Battlecry.createBattlecry(FacelessSpell.create(), TargetSelection.MINIONS);
