...
public class BestialWrath extends SpellCard {
	...
	public BestialWrath() {
		...
		Spell buffAttackSpell = new BuffSpell(2, 0, true);
		Spell immunitySpell = new ApplyTagSpell(GameTag.IMMUNE, new TurnEndTrigger());
		setSpell(new MetaSpell(buffAttackSpell, immunitySpell));
