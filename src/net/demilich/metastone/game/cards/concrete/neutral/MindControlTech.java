...
public class MindControlTech extends MinionCard {
	...
	public Minion summon() {
		...
		SpellDesc mindControlSpell = MindControlSpell.create(EntityReference.ENEMY_MINIONS, true);
		BattlecryAction battlecry = BattlecryAction.createBattlecry(mindControlSpell);
