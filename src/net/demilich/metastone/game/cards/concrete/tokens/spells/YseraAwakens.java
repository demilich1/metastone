...
public class YseraAwakens extends SpellCard {
	...
	public YseraAwakens() {
		...
		// SpellDesc yseraAwakens =
		// DamageSpell.create(EntityReference.ALL_CHARACTERS,
		// (context, player, target) -> target.getTag(GameTag.UNIQUE_ENTITY) ==
		// UniqueEntity.YSERA ? 0 : 5);
		SpellDesc yseraAwakens = DamageSpell.create(EntityReference.ALL_CHARACTERS, null);
