...
public class GamesImpl extends Service<GamesImpl> implements Games {
	private GameSessionsImpl gameSessions;
	...
	public void start(Future<Void> done) {
		if (gameSessions == null) {
			...
			done.fail(new NullPointerException("gameSessions wasn't configured when the GamesImpl verticle was started. Please inject this dependency."));
		} else {
			EventBus eb = vertx.eventBus();
			// Configure the expire match method
			eb.consumer("GamesImpl::expireMatch", message -> {
	...
	public GameSessionsImpl getGameSessions() {
		return gameSessions;
	}

	public void setGameSessions(GameSessionsImpl gameSessions) {
		this.gameSessions = gameSessions;
	}

	public GamesImpl withGameSessions(GameSessionsImpl gameSessions) {
